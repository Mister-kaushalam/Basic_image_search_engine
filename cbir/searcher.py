#this will  handle comparing feature vectors, and thus the actual similarity of two images
...
class Searcher:
    ...
    def search(self, queryFeatures, numResults=10):
        #initalize the result directory
        results={}

        #open the database for reading
        with open(self.dbPath) as f:
            #initalize the csv reader
            reader = csv.reader(f)
        ...
        #sort our results, so that smaller distance are at the front of the lists
